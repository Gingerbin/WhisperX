        ...
        with tabs[0]:
            for i, seg in enumerate(segments):
                ...
                card_html = f"""<div class="segment-card" data-start="{start_sec}" data-end="{end_sec}" data-color="{color}">
                    ...
                    <!-- Action Row (Hidden until Hover/Touch) -->
                    <div class="action-row">
                        <a class="inline-action play" data-time="{start_sec}">▶ Play</a>
                        <a class="inline-action stats" data-target="stats-{i}">📊 Stats</a>
                    ...
                    <div id="stats-{i}" style="display:none; margin-top: 10px;">
                        {metrics_html}
                    </div>
                ...
                # Invisible hooks to link JS clicks to Streamlit buttons
                with st.container():
